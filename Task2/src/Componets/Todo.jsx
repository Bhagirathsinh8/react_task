...
export default function Todo() {
  ...
  return (
    <div>
        <h1>Task - 2 Todo </h1>
        <input type='text' placeholder='Enter List item' value={inputData} onChange={handleInput}/>
        ...
        <h1>Todo List</h1>
        {
                list.length === 0 ?  (<p>No items in the list</p>) : (
                    ...
                    list.map((item, index)=>{
                        return(
                            <>
                        <div key={index} style={{padding:"4px",display:"flex", gap:"10px" ,alignItems:"center"}}>
                        {item}
